...
namespace Imagine {
  ...
  class CoefficientsTable {
    public:
       ...
       */
      bool
      isEmptyAtPoint(const Point<double>& p) const;
      /**
      ...
      getCoefficientsAtPoint(const Point<double>& p) const;
      /**
       ...
       */
      void
      setCoefficientsAtPoint(const Point<double>& p,
    ...
    private:
      ...
      std::size_t
      getPositionForPoint(const Point<double>& p) const;
  };
}
